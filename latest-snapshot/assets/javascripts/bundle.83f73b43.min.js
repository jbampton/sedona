...
(() => {
    ...
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let n of Vi(t))
        !yr.call(e, n) &&
          ...
          gr(e, n, {
            get: () => t[n],
            enumerable: !(o = Di(t, n)) || o.enumerable,
          });
    return e;
  };
  var Mt = (e, t, r) => (
  ...
  var Br = xr((It, Yr) => {
     ...
     */ (function (t, r) {
      typeof It == 'object' && typeof Yr == 'object'
        ? (Yr.exports = r())
        : typeof define == 'function' && define.amd
          ? define([], r)
          : typeof It == 'object'
        ...
        var e = {
            686: function (o, n, i) {
              ...
              var ft = function () {
                  ...
                  if ($e) return J($e, {container: D});
                  if (Y) return F === 'cut' ? y(Y) : J(Y, {container: D});
                },
                qe = ft;
              function Fe(V) {
                '@babel/helpers - typeof';
              ...
              function Hi(V, A, M) {
                return A && no(V.prototype, A), M && no(V, M), V;
              }
              function $i(V, A) {
              ...
              function Pi(V) {
                ...
                return function () {
                  ...
                  if (A) {
                    ...
                    D = Reflect.construct(F, arguments, Y);
                    ...
                    Hi(
                      ...
                      [
                        ...
                        },
                        {
                          ...
                          value: function (D) {
                            var Y = this;
                            this.listener = c()(D, 'click', function ($e) {
                              return Y.onClick($e);
                            });
                          },
                        },
                          ...
                          value: function () {
                            ...
                            return (
                              Y.forEach(function (Dt) {
                                $e = $e && !!document.queryCommandSupported(Dt);
                              }),
                              $e
                            );
                          },
...
` +
  ...
  var _t = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (o.isStopped = !1),
        r ? ((o.destination = r), qt(r) && r.add(o)) : (o.destination = Yi),
        o
      );
    }
    return (
  ...
  function Gi(e) {
    return (e && e instanceof _t) || (Bi(e) && qt(e));
  }
  function Ji(e) {
  ...
  var gt = (function (e) {
    ...
    return (
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          n === void 0 && (n = 0), kt.setInterval(r.flush.bind(r, this), n)
        );
      }),
  ...
  function Ro(e, t) {
    if (e != null) {
      if (Jt(e)) return Co(e, t);
      if (xt(e)) return Ho(e, t);
      if (Gt(e)) return ko(e, t);
      if (Xt(e)) return nr(e, t);
      if (tr(e)) return $o(e, t);
      if (or(e)) return Po(e, t);
    }
    throw Zt(e);
  }
  function ue(e, t) {
  ...
  function sa(e, t) {
    return aa(t) ? e.apply(void 0, q([], N(t))) : e(t);
  }
  function Ze(e) {
    return m(function (t) {
      return sa(e, t);
  ...
  function ie() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return function (r) {
      return We(r, I.apply(void 0, q([], N(e))));
    };
  }
  function _(e) {
    return E(function (t, r) {
        ...
        ft.add(function () {
          ...
          !l &&
            ...
            ((l = new at({
              ...
              error: function (Fe) {
                (L = !0), X(), (f = Ur(te, n, Fe)), qe.error(Fe);
              },
              complete: function () {
                (y = !0), X(), (f = Ur(te, a)), qe.complete();
              },
            })),
            U(k).subscribe(l));
      })(c);
  ...
  function Ur(e, t) {
    ...
    if (t !== !1) {
      ...
      return U(t.apply(void 0, q([], N(r)))).subscribe(n);
    }
  }
  function G(e, t, r) {
    var o,
  ...
  function Yo(e, t) {
    return E(function (r, o) {
      var n = t != null ? t : {},
        ...
        L = function (te) {
          return (f = U(e(te)).subscribe(T(o, d, y)));
        },
        X = function () {
          if (c) {
            c = !1;
            var te = l;
            (l = null), o.next(te), !u && L(te);
          }
        };
      r.subscribe(
        T(
  ...
  function Bo() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return E(function (r, o) {
      st.apply(void 0, q([r], N(e))).subscribe(o);
    });
  }
  function Vr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return Bo.apply(void 0, q([], N(e)));
  }
  function Go() {
    let e = new Ct(1);
    return (
  ...
  function $t(e, t) {
    return C(() =>
      ...
      ).pipe(t ? Ht((r) => Le(+!r * t)) : le, Q(e.matches(':hover'))),
    );
  }
  function Jo(e, t) {
  ...
  var Xo = new g(),
    Ta = C(() =>
      typeof ResizeObserver == 'undefined'
        ? Tt('https://unpkg.com/resize-observer-polyfill')
        : I(void 0),
    ).pipe(
  ...
  var Ca = R('#__config'),
    Ot = JSON.parse(Ca.textContent);
  Ot.base = `${new URL(Ot.base, ye())}`;
  function xe() {
    return Ot;
  }
  function B(e) {
    return Ot.features.includes(e);
  }
  function Ee(e, t) {
    return typeof t != 'undefined'
      ? Ot.translations[e].replace('#', t.toString())
      : Ot.translations[e];
  }
  ...
  function Na(e) {
    return ge(e).pipe(
      m(({width: t}) => ({scrollable: St(e).width > t})),
      ee('scrollable'),
    );
  }
  function jn(e, t) {
  ...
  function Ka() {
    return typeof mermaid == 'undefined' || mermaid instanceof Element
      ? Tt('https://unpkg.com/mermaid@11/dist/mermaid.min.js')
      : I(void 0);
  }
  function Wn(e) {
    return (
  ...
  var Dn = x('table');
  function Vn(e) {
    return e.replaceWith(Dn), Dn.replaceWith(An(e)), I({ref: e});
  }
  function Ya(e) {
  ...
  function zn(e, {viewport$: t, target$: r, print$: o}) {
    return O(
      ...
      ...P('table:not([class])', e).map((n) => Vn(n)),
      ...P('details', e).map((n) => Fn(n, {target$: r, print$: o})),
      ...P('[data-tabs]', e).map((n) => Nn(n, {viewport$: t, target$: r})),
      ...P('[title]', e)
  ...
  function Ba(e, {alert$: t}) {
    return t.pipe(
      v((r) =>
        O(I(!0), I(!1).pipe(Ge(2e3))).pipe(m((o) => ({message: r, active: o}))),
      ),
    );
  }
  function qn(e, t) {
  ...
  function Ja(e, t) {
    ...
    let o = cr(t),
      n = typeof o != 'undefined' ? Ne(o) : I({x: 0, y: 0}),
      i = O(et(t), $t(t)).pipe(K());
    return z([i, n]).pipe(
      m(([a, s]) => {
        let {x: p, y: c} = Ve(t),
  ...
  function Yn(e, {header$: t, main$: r}) {
    return C(() => {
      let o = new g(),
        n = o.pipe(Z(), ie(!0));
      o.pipe(ee('active'), He(t)).subscribe(([{active: a}, {hidden: s}]) => {
  ...
  function Jn(e) {
    ...
    let n = Pt('(prefers-color-scheme: light)');
    return C(() => {
      let i = new g();
      return (
        i.subscribe((a) => {
  ...
  function oi({location$: e, viewport$: t, progress$: r}) {
    ...
    return (
      ...
      t.pipe(ee('offset'), _e(100)).subscribe(({offset: p}) => {
  ...
  function ai(e, t) {
    let r = yn(e);
    return (
      O(I(location.protocol !== 'file:'), ze('search'))
        .pipe(
          Ae((o) => o),
          v(() => t),
        )
  ...
  function ls(e, {worker$: t}) {
    ...
    let o = et(e),
      n = O(t.pipe(Ae(jt)), h(e, 'keyup'), o).pipe(
        m(() => e.value),
        K(),
      );
    return z([n, o]).pipe(
  ...
  function li(e, {worker$: t, query$: r}) {
    ...
    ze('search').subscribe((l) =>
      s.setAttribute('role', l ? 'list' : 'presentation'),
    ),
      o
        .pipe(re(r), Wr(t.pipe(Ae(jt))))
  ...
  function Ei(e, {viewport$: t, header$: r, main$: o, target$: n}) {
    ...
    return (
      ...
      r.pipe(W(a), ee('height')).subscribe(({height: s}) => {
        e.style.top = `${s + 16}px`;
      }),
  ...
  function ys() {
    return location.protocol === 'file:'
      ? Tt(`${new URL('search/search_index.js', eo.base)}`).pipe(
          m(() => __index),
          G(1),
        )
  ...
  var ot = Go(),
    ...
    to = an(),
    Oe = gn(),
    hr = Pt('(min-width: 960px)'),
    Mi = Pt('(min-width: 1220px)'),
    _i = mn(),
    eo = xe(),
  ...
  B('navigation.instant') &&
    oi({location$: Ut, viewport$: Oe, progress$: oo}).subscribe(ot);
  var Li;
  ...
  var rt = Kn(Se('header'), {viewport$: Oe}),
    ...
    xs = O(
      ...ae('consent').map((e) => En(e, {target$: Lt})),
    ...
    Es = C(() =>
      O(
        ...
        ...ae('content').map((e) =>
          zn(e, {viewport$: Oe, target$: Lt, print$: _i}),
        ),
        ...ae('content').map((e) =>
          B('search.highlight') ? di(e, {index$: Ai, location$: Ut}) : S,
        ),
        ...ae('header').map((e) =>
          Yn(e, {viewport$: Oe, header$: rt, main$: Ft}),
        ),
        ...ae('header-title').map((e) => Bn(e, {viewport$: Oe, header$: rt})),
        ...ae('sidebar').map((e) =>
          e.getAttribute('data-md-type') === 'navigation'
            ? Nr(Mi, () => Zr(e, {viewport$: Oe, header$: rt, main$: Ft}))
            : Nr(hr, () => Zr(e, {viewport$: Oe, header$: rt, main$: Ft})),
        ),
        ...ae('tabs').map((e) => yi(e, {viewport$: Oe, header$: rt})),
        ...ae('toc').map((e) =>
          xi(e, {viewport$: Oe, header$: rt, main$: Ft, target$: Lt}),
        ),
        ...ae('top').map((e) =>
          Ei(e, {viewport$: Oe, header$: rt, main$: Ft, target$: Lt}),
        ),
      ),
    ),
    Ci = ot.pipe(
